...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    $sqlget = "SELECT Stud_name,book_name,author, date(iss_rec.iss_date) as Date FROM student,book,iss_rec,membership WHERE student.Stud_no=membership.Stud_no AND membership.Mem_no=iss_rec.Mem_no AND iss_rec.Book_no=book.Book_no and date(iss_rec.iss_date)='$iss_date';";
