...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    $sqlget = "SELECT Stud_name,COUNT(iss_rec.Mem_no) as Total_num_of_books FROM student,book,iss_rec,membership WHERE student.Stud_no=membership.Stud_no AND membership.Mem_no=iss_rec.Mem_no AND iss_rec.Book_no=book.Book_no GROUP BY student.Stud_no HAVING COUNT(iss_rec.Mem_no) = 3";
